...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { event_id: @participant.event_id, participant_id: @participant.participant_id } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { event_id: @participant.event_id, participant_id: @participant.participant_id } }
